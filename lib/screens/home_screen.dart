...
import '../screens_main/notification_page.dart';
import '../screens_main/chat_page.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildAdminBox(
                      "Store Chat",
                      Icons.chat_outlined,
                      "Communicate with other store members.",
                      () {
                        setState(() {
                          _selectedOption = "Store Chat";
                          _currentContent = const ChatPage();
                        });
                      },
                      _selectedOption == "Store Chat",
                    ),
